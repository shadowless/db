...
?>
<div class="s-bk-lf">
	<div class="hst-title">Создать аккаунт</div>
</div>
				...
				if($pass !== false){
					...
					if($pass == $_POST["repass"]){
						...
						return;
							...
							}else echo "<center><b><font color = 'green'>Вы успешно зарегистрировались. Используйте форму слева для входа в аккаунт</font></b></center><BR />";
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <td class="naz2" align="left" style="padding:3px;">Ваш псевдоним: <font color="#FF0000">*</font></td>
    <td align="left" style="padding:3px;"><input class="lg" style="width: 150px;" name="login" type="text" size="25" maxlength="10" value=""></td>
  </tr>
  <tr>
    <td class="naz2" colspan="2" align="left" style="padding:3px;">Поле псевдоним должно иметь от 4 до 10 символов (только англ. символы).</td>
    </tr>
<tr>
  ...
  <tr>
    <td class="naz2" align="left" style="padding:3px;">Пароль: <font color="#FF0000">*</font></td>
    <td align="left" style="padding:3px;"><input class="lg" style="width: 200px;" name="pass" type="password" size="25" maxlength="20"></td>
  </tr>
  <tr>
    <td class="naz2" colspan="2" align="left" style="padding:3px;">Поле Пароль должно иметь от 6 до 20 символов (только англ. символы).</td>
    </tr>
  <tr>
    <td class="naz2" align="left" style="padding:3px;">Пароль еще раз: <font color="#FF0000">*</font></td>
    <td align="left" style="padding:3px;"><input class="lg" style="width: 200px;" name="repass" type="password" size="25" maxlength="20"></td>
  </tr>
  <tr>
    <td class="naz2" colspan="2" align="left" style="padding:3px;">Пароли должны совпадать.</td>
    </tr>
  <tr>
    <td colspan="2" align="left">&nbsp;</td>
  </tr>
...
<tr>
    ...
    <td align="left" style="padding:3px;">Введите символы с картинки<input class="lg" style="width: 180px;" name="captcha" type="text" size="25" maxlength="50"></td>
  </tr>
  <tr>
    <td colspan="2" align="left">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" align="center" style="padding:3px;"><input class="btn_kup" style="width: 150px;" name="registr" type="submit" value="Зарегистрироваться"></td>
  </tr>
</tbody></table>
</form>
