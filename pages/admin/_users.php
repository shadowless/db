<div class="cl-right">
<div class="s-bk-lf">
	<div class="hst-title">Пользователи</div>
</div>
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Продукции на балансе (Лайм):</td>
    <td width="200" align="center"><?=$data["a_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Продукции на балансе (Вишня):</td>
    <td width="200" align="center"><?=$data["b_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Продукции на балансе (Клубника):</td>
    <td width="200" align="center"><?=$data["c_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Продукции на балансе (Киви):</td>
    <td width="200" align="center"><?=$data["d_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Продукции на балансе (Апельсин):</td>
    <td width="200" align="center"><?=$data["e_b"]; ?></td>
  </tr>
  
  
  <tr>
    <td style="padding-left:10px;">Саженцев (Лайм):</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Саженцев (Вишня):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Саженцев (Клубника):</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Саженцев (Киви):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Саженцев (Апельсин):</td>
    <td width="200" align="center">
