...
<div class="cl-right">
<div class="s-bk-lf">
	<div class="hst-title">Конкурс рефералов</div>
</div>
...
<table width="99%" border="0" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="border: 1px dashed #db8;" align="center" width="75" class="m-tb">Позиция</td>
    <td style="border: 1px dashed #db8;" align="center" class="m-tb">Пользователь</td>
    <td style="border: 1px dashed #db8;" align="center" class="m-tb">Баллов</td>
	...
	<?PHP
		...
		?>
			<tr class="htt" >
				<td style="border: 1px dashed #db8;" align="center" width="75"><?=$position; ?></td>
				<td style="border: 1px dashed #db8;" align="center"><?=$data["user"]; ?></td>
				<td style="border: 1px dashed #db8;" align="center"><?=sprintf("%.0f",$data["points"]); ?></td>
				<td style="border: 1px dashed #db8;" align="center"><?=(intval($comp["{$position}m"]) > 0) ? $comp["{$position}m"]." RUB" : "-" ?></td>
		 	</tr>
		<?PHP
		$position++;
		}
