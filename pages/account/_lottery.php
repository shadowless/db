...
?>
<div class="s-bk-lf">
	<div class="hst-title">Лотерея</div>
</div>
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  ...
  <tr>
     ...
     <td style="border: 1px dashed #db8;" align="center" class="m-tb">Пользователь<BR />[Билет]</td>
	 <td style="border: 1px dashed #db8;" align="center" class="m-tb">Пользователь<BR />[Билет]</td>
	 <td style="border: 1px dashed #db8;" align="center" class="m-tb">Пользователь<BR />[Билет]</td>
	 <td style="border: 1px dashed #db8;" align="center" class="m-tb">Банк</td>
  ...
  $db->Query("SELECT * FROM db_lottery_winners ORDER BY id DESC");
	...
	if($db->NumRows() > 0){
		...
		?>
		<tr class="htt">
    		 <td style="border: 1px dashed #db8;" align="center"><?=$ref["id"]; ?></td>
			 <td style="border: 1px dashed #db8;" align="center"><?=$ref["user_a"]; ?><BR />Билет: <?=$ref["bil_a"]; ?></td>
			 <td style="border: 1px dashed #db8;" align="center"><?=$ref["user_b"]; ?><BR />Билет: <?=$ref["bil_b"]; ?></td>
			 <td style="border: 1px dashed #db8;" align="center"><?=$ref["user_c"]; ?><BR />Билет: <?=$ref["bil_c"]; ?></td>
			 <td style="border: 1px dashed #db8;" align="center"><?=$ref["bank"]; ?></td>
			 <td style="border: 1px dashed #db8;" align="center"><?=date("d.m.Y",$ref["date_add"]); ?></td>
  		</tr>
		<?PHP
...
1 место - 50% от общего банка [<?=($amount_lottery * $num_bil) * 0.5; ?> сахара]. <BR />
2 место - 25% от общего банка [<?=($amount_lottery * $num_bil) * 0.25; ?> сахара]. <BR />
3 место - 20% от общего банка [<?=($amount_lottery * $num_bil) * 0.2; ?> сахара]. <BR />
Остальные 5% составляют комиссию системы.
<BR />
<u>Стоимость билета = <?=$amount_lottery; ?> сахара</u>.
<BR />
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  ...
  <tr>
     <td style="border: 1px dashed #db8;" align="center" class="m-tb">№ билета</td>
