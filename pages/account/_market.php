...
<div class="s-bk-lf">
	<div class="hst-title">Торговая лавка</div>
</div><font color="FFffff">
Торговая лавка позволит вам продать все ваши сигареты за сахар, который можно обменять на реальные 
деньги. 
<br>

Вырученный  с продажи сахар распределяется между двумя счетами (счет для покупок и счет 
для вывода) в пропорциях: <?=100-$sonfig_site["percent_sell"]; ?>% на счет для покупок и <?=$sonfig_site["percent_sell"]; ?>% на вывод.<br /><br /></font>
Курс продажи любых сигарет: <font color="#fff000"><?=$sonfig_site["items_per_coin"]; ?> сигарет = 1 сахар.</font>
...
$all_items = $user_data["a_b"] + $user_data["b_b"] + $user_data["c_b"] + $user_data["d_b"] + $user_data["e_b"];
	...
	if($all_items > 0){
		...
		echo "<center><font color = 'green'><b>Вы продали {$all_items} сигарет, на сумму {$money_add} сахара</b></font></center><BR />";
...
<table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td height="30" align="center" valign="middle"><strong>На сумму (сахар)</strong></td>
  </tr>
  <tr>
    <td width="30" height="30" align="center" valign="middle"><div class="sm-line-nt"><img src="/img/fruit/lime-small.jpg" /></div></td>
    <td align="center" valign="middle"><?=$user_data["a_b"]; ?> сигарет</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?=$user_data["b_b"]; ?> сигарет</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?=$user_data["c_b"]; ?> сигарет</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?=$user_data["d_b"]; ?> сигарет</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?=$user_data["e_b"]; ?> сигарет</td>
