...
<table width="330" border="0" align="center">
  <tr>
    ...
    <td align="center"><input class="lg" style="width: 150px;" type="password" name="old" /></td>
  </tr>
  <tr>
    <td><b>Новый пароль:</b></td>
    <td align="center"><input class="lg" style="width: 150px;" type="password" name="new" /></td>
  </tr>
  <tr>
    <td><b>Повтор пароля:</b></td>
    <td align="center"><input class="lg" style="width: 150px;" type="password" name="re_new" /></td>
  </tr>
  <tr>
    <td align="center" colspan="2"><BR /><input class="btn_kup" style="width: 130px;" type="submit" value="Сменить пароль" /></td>
  </tr>
</table>
</form>
<BR />
