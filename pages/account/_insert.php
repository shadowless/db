...
<div class="s-bk-lf">
<center>
 <div class="hst-title">Пополнение баланса</div>
 </center>
</div>
...
<div class="naz2">
<font color="FFffff">Курс игровой валюты: 1 рубль (<?=$config->VAL; ?>) = <?=$sonfig_site["ser_per_wmr"]; ?> сигарет.
<p>Ввод средств позволяет автоматически приобрести сигареты с помощью различных платежных 
...
После пополнения вам будет зачислено сигареты.<br /></p><font>
...
<form method="GET" action="//payeer.com/api/merchant/m.php">
 ...
 <input  class="btn_kup" style="width: 200px;" type="submit" name="m_process" value="Оплатить и получить сигареты"/>
...
function calculate(st_q) {
 ...
 $('#res_sum').html( (sum_insert * ser_pr).toFixed(o) );
...
<input type="text" value="100" name="sum" size="7" id="psevdo" onchange="calculate(this.value)" onkeyup="calculate(this.value)" onfocusout="calculate(this.value)" onactivate="calculate(this.value)" ondeactivate="calculate(this.value)"> 
    ...
    Вы получите <span id="res_sum">10000</span> сигарет
 <BR /><BR />
   
 <input style="margin: 20px;margin-left: 150px;" class="btn_kup"; style="width: 200px;" type="submit" id="submit" value="Пополнить">
</form>
<script type="text/javascript">
calculate(100);
</script>
